        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className={`w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl ${isDark ? 'bg-gray-800' : 'bg-white'
                        }`}
                                ...
                                <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-700' : 'bg-gray-50'}`}>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <motion.a
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            className={`flex items-center justify-center space-x-2 w-full p-3 rounded-lg transition-colors ${isDark ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'
                                                } text-white`}
                                        >
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <div className="space-y-4">
                                    {providerInfo.steps.map((step, index) => (
                                        <motion.div
                                            key={index}
                                            className={`p-4 rounded-lg border-2 transition-all cursor-pointer ${activeStep === index + 1
                                                    ? isDark
                                        ...
                                        >
                                            <div className="flex items-start space-x-3">
                                                <div
                                                    className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${activeStep === index + 1
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${activeStep === index + 1
                                                                ? 'bg-blue-500 text-white'
                                                                : isDark
                                                                    ? 'bg-gray-600 text-gray-300'
