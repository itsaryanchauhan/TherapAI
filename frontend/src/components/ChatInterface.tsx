    ...
    try {
      ...
      if (useMediaRecorder && hasApiKey('elevenlabs')) {
        ...
        mediaRecorder.onerror = (event) => {
          ...
          setMicPermissionError("Recording failed. Please try again.");
        ...
        recognition.onerror = event => {
          ...
          if (event.error === 'not-allowed') {
            setMicPermissionError('Microphone access was denied. Please allow microphone access and try again.');
          } else if (event.error === 'no-speech') {
            setMicPermissionError('No speech detected. Please try speaking closer to your microphone.');
          } else if (event.error === 'audio-capture') {
            setMicPermissionError('Audio capture failed. Please check your microphone connection.');
          } else {
        ...
        stream.getTracks().forEach(track => track.stop());
        setMicPermissionError("Speech recognition is not supported in your browser.");
      }
    } catch (error) {
