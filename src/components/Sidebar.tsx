...
import { MessageSquare, BarChart3, Users, Settings, LogOut, Sun, Moon, User, Zap, Crown } from 'lucide-react';
        ...
        {!isCollapsed && (
          <div className="pt-2">
            <a
              ...
              className={`flex items-center justify-center space-x-2 px-3 py-2 rounded-xl text-xs transition-colors duration-200 ${
                isDark
